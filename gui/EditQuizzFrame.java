 ...
 * @author hmayw
 */
public class EditQuizzFrame extends javax.swing.JFrame {

     private List<QuestionPojo> questions;
     private int counter;
     private QuestionPojo queRef;
    public EditQuizzFrame() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/NewPhotos/pngegg (11).png"))); // NOI18N
        jPanel1.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 60, -1, -1));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/NewPhotos/pngegg (8).png"))); // NOI18N
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, -20, 710, 370));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditQuizzFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

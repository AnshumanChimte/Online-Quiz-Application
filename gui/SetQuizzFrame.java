 ...
 * @author hmayw
 */
public class SetQuizzFrame extends javax.swing.JFrame {

     private int counter;
     private String jobId;
     private List<QuestionPojo> questions;
     
    public SetQuizzFrame() {
        initComponents();
    ...
    public SetQuizzFrame(String jobId)
    {
       this(); 
       this.jobId=jobId;
    }
    ...
    private void initComponents() {
        ...
        jLabel16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/NewPhotos/pngegg (11).png"))); // NOI18N
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, -20, 710, 370));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SetQuizzFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
